                ...
                @foreach ($areas as $index => $area)
                    ...
                    @enderror
                            ...
                            @php
                                ...
                                $inputType = null;
                                if ($selectedType) {
                                    $rateRecord = \Fuelviews\SabHeroEstimator\Models\Rate::where('surface_type', $selectedType)->first();
            ...
            <div x-data="{ showConfirm: false }">
                ...
                <div x-show="showConfirm" x-transition class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div class="bg-white p-6 rounded shadow-lg max-w-md w-full">
                        ...
                        <div class="flex justify-end">
                            <button @click="showConfirm = false" class="mr-2 px-4 py-2 border rounded">
                                Cancel
                            </button>
                            <!-- When confirmed, call the Livewire method to submit and then hide the modal -->
                            <button @click="$wire.submitProject(); showConfirm = false" class="bg-blue-500 text-white px-4 py-2 rounded">
                                Yes, Submit
                            </button>
                        </div>
                    </div>
